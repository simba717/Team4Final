...
<div class="loginbody">
	...
	<div class="logincontainer" id="logincontainer">
		...
		<div class="form-logincontainer sign-in-container">
				...
				<input type="text" name="checkcode" placeholder="請輸入您的驗證碼" /> 
				<input type="password" name="password" placeholder="請輸入您的新密碼" /> 
				<input type="password" name="checkpassword" placeholder="確認密碼" /> 
				<br>
				<br>
				
				
				<button class="loginbutton" >確認修改</button>
			</form>
