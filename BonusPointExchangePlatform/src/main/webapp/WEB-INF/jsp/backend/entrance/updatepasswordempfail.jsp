...
<div class="loginbody">
	...
	<div class="logincontainer" id="logincontainer">
		...
		<div class="form-logincontainer sign-in-container">
				<form class="loginform" action="sendemailemp" method="post">
			
				<h1 class="logingh1">Change Password</h1>
				
				<input type="text" name="account" placeholder="請輸入您的員工帳號" /> 
				<input type="text" name="email" placeholder="請輸入您的員工信箱" /> 
				<p style="text-align:center;color: red;font-weight:bold;">帳號信箱錯誤</p>
