	...
	<div align='center'>
		<select name="TotalOrAnalyze"
			...
			<optgroup label="銷售分析">
				...
				<option value="http://localhost:8080/my-app/monthsearch" selected="true">本月銷售</option>
			</optgroup>
		</select>
	</div>
<br><br><br>
		...
		<script>
			...
			xhr1.onreadystatechange = function() {
				if (xhr1.readyState == 4 && xhr1.status == 200) {
					...
					xhr2.open("Get", "<c:url value='/product/monthgroup2' />",
							true);
					xhr2.send();
					xhr2.onreadystatechange = function() {
						if (xhr2.readyState == 4 && xhr2.status == 200) {
							...
							xhr3.open("Get",
									"<c:url value='/product/monthgroup3' />",
									true);
							xhr3.send();
							xhr3.onreadystatechange = function() {
								if (xhr3.readyState == 4 && xhr3.status == 200) {
									...
									xhr4
											.open(
													"Get",
													"<c:url value='/product/monthgroup4' />",
													true);
									xhr4.send();
