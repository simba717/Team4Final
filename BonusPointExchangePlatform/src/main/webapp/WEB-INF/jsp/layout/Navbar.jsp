							...
							<div class="book_room">
								<div class="dropdown" style="margin-right: 5px; display: block;"
									...
									<ul class="dropdown-menu dropdown-menu-dark"
										...
										<li><a class="dropdown-item"
											href="${contextRoot}/frontend/EditMemberByMember" id="1">編輯個人資料</a></li>
										<li><a class="dropdown-item"
											href="${contextRoot}/MembergoBankAccount" id="2">查看帳戶資訊</a></li>
										<li><a class="dropdown-item"
											href="${contextRoot}/campaign/gameRecord" id="3">遊戲紀錄查詢</a></li>
								...
								<div class="socail_links">
									<ul>
										<li><a href="${contextRoot}/shoppingCart"><i
												class="fa fa-cart-shopping" style="font-size: 45px"></i> </a></li>
										<li><a href="#" id="dropdownorderLink"
											data-bs-toggle="dropdown" data-bs-auto-close="false"
											aria-expanded="false"> <i
												class="fa-solid fa-bell position-relative"
												style="font-size: 40px"> <span style="font-size: 0.3em;"
													class="position-absolute top-100 start-100 translate-middle badge rounded-pill bg-danger"></span></i>
										</a> <!-- 	購物車內容		     -->
											<div id="orderListContent"
												class="dropdown-menu p-0 overflow-auto"
										...
										<li><a href="${contextRoot}/toBack"><i
												class="fa fa-right-to-bracket" style="font-size: 40px"></i>
								...
								<div class="book_btn d-none d-xl-block">
									<a class="#" href="${contextRoot}/login" id="loginbtn"
										style="background-color: white; color: orange">登入/註冊</a> <a
										class="#" href="${contextRoot}/logout" id="logoutbtn"
