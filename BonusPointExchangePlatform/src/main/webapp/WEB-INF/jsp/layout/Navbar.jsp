														...
														<ul id="navigation">
															...
															<li><a href="#">與我聯繫<i class="ti-angle-down"></i></a>
																<ul class="submenu">
																	...
																	<li><a href="#" onclick="window.open('http://localhost:8080/my-app/chatroom.html', 'WebSocket', config='height=1000,width=500');">線上客服</a></li>
										...
										<div class="dropdown" style="margin-right:5px; display:block;" id="memberdiv">
											...
											<ul class="dropdown-menu dropdown-menu-dark"
												...
												<li><a class="dropdown-item"
														href="${contextRoot}/frontend/EditMemberByMember"
														id="1">編輯個人資料</a></li>
												<li><a class="dropdown-item" href="${contextRoot}/MembergoBankAccount"
														id="2">查看帳戶資訊</a></li>
												<li><a class="dropdown-item" href="${contextRoot}/campaign/gameRecord"
														id="3">遊戲紀錄查詢</a></li>
